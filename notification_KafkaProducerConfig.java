...
/**
 * KafkaProducerConfig for notification-service.
 *
 * Notification-service only consumes, but KafkaTemplate<Object,Object> is required
 * by DeadLetterPublishingRecoverer to route failed notification events to <topic>.DLT.
 */
@Configuration
